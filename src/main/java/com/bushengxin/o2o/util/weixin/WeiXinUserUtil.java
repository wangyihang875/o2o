package com.bushengxin.o2o.util.weixin;

import com.bushengxin.o2o.entity.PersonInfo;
import com.bushengxin.o2o.util.DESUtils;
...
//		String appId = DESUtils.getDecryptString(pro.getProperty("weixinappid"));
        String appId = pro.getProperty("weixinappid");
        log.debug("appId:" + appId);
//        String appsecret = DESUtils.getDecryptString(pro.getProperty("weixinappsecret"));
		String appsecret = pro.getProperty("weixinappsecret");
        ...
        /*
         * 在实体类中，可以在成员变量上加注解如：@JsonProperty("openid")来对字段进行序列化和反序列化
         * */
        UserAccessToken token = new UserAccessToken();
		/*
		//可以用这种方式直接将jsonstr转成实体对象
		ObjectMapper objectMapper = new ObjectMapper();
		token = objectMapper.readValue(jsonObject.toString(),UserAccessToken.class);
		*/
