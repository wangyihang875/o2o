...
import com.bushengxin.o2o.dao.ProductImgDao;
...
public class ProductServiceImpl implements ProductService {
	...
	* */
	public ProductExecution addProduct(Product product, CommonsMultipartFile thumbnail, List<CommonsMultipartFile> productImgs) throws RuntimeException {
		if (product != null && product.getShop() != null && product.getShop().getShopId() != null) {
			...
			try {
				...
				throw new RuntimeException("addProduct error:" + e.toString());
			}
	...
	private void addProductImgs(Product product, List<CommonsMultipartFile> productImgs) {
		...
		if (imgAddrList != null && imgAddrList.size() > 0) {
			...
			try {
				...
				throw new RuntimeException("addProductImgs error:" + e.toString());
			}
		}
	}
