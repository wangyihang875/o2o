...
public class ProductDetailController {
	...
	@RequestMapping(value = "/getproductdetailpageinfo", method = RequestMethod.GET)
	@ResponseBody
	private Map<String, Object> getProductDetailPageInfo(
...
//			String content = "{\"productId\":" + productId + ",\"customerId\":"+ user.getUserId() + ",\"createTime\":" + timpStamp + "}";
